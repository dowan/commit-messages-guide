...
Un guide pour comprendre l'importance des messages de commit et comment bien les écrires.

Cela va vous aider à apprendre qu'est-ce qu'un commit, pourquoi il est important d'écrire des bons messages, les bonnes
pratiques et quelques astuces pour prévoir et (r)écrire de bons commits.
...
Pour faire simple, un commit est _snapshot_ de vos fichiers locaux, écrit dans votre dossier local.
Contrairement à ce que certaines personnes pensent, [git ne stocke pas que la différence entre les fichiers, il stocke
une version complète de tous les fichiers](https://git-scm.com/book/eo/v1/Ekkomenci-Git-Basics#Snapshots,-Not-Differences).
Pour les fichiers qui ne changent pas d'un commit à l'autre, git va simplement stocker un lien vers le fichier qui est
déjà stocké.

L'image en dessous nous montre comment git stock les données dans le temps, ou chaque "Version" est un commit:

![](https://i.stack.imgur.com/AQ5TG.png)

## Pourquoi les messages de commits sont-il important?

- Pour accélerer et rationaliser les revues de code
- Pour aider à comprendre les changements
- Pour expliquer ce qui ne peut pas etre juste expliqué via le code 
- Pour aider les futurs mainteneurs a comprendre pourquoi les changements ont été fait, simplifier la résolution de
  problèmes

Pour maximiser ces résultats, nous pouvons utiliser des bonnes pratiques et des standards qui sont expliqués dans la
prochaine section.

## Bonnes practiques

Voici les pratiques acquises au cour de mon expérience, des articles, et des guides. Si vous en avez d'autres (ou que
vous n'etes pas d'accord) vous pouvez contribuer.

### Utilisez la forme impérative 
...
_Mais pourquoi utiliser la forme impérative?_

Un message de commit décrit ce que le changement change
